...
# for ezgo
installpackages+="vim vim-gtk gksu kdesudo zenity im-switch chromium-browser language-pack-zh-hant firefox-locale-zh-hant language-pack-zh-hant-base language-pack-gnome-zh-hant language-pack-kde-zh-hant kde-l10n-zhtw kdeedu kdegraphics kdemultimedia firefox "
# hime
...
# kdegames
installpackages+="kdegames supertux supertuxkart pingus tuxmath tuxtype "
# scribus
